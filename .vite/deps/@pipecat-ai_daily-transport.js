...
function B(e2) {
  return null != e2 && e2.callObjectBundleUrlOverride ? e2.callObjectBundleUrlOverride : F("https://c.daily.co/call-machine/versioned/".concat("0.86.0", "/static/call-machine-object-bundle.js"), e2);
}
function U(e2) {
  try {
    new URL(e2);
  ...
  return l(r2, b), o(r2, [{ key: "destroy", value: (ee2 = p((function* () {
    ...
    return void 0 !== t2.showLocalVideo && (this._callObjectMode ? console.error("showLocalVideo is not available in callObject mode") : this._showLocalVideo = !!t2.showLocalVideo), void 0 !== t2.showParticipantsBar && (this._callObjectMode ? console.error("showParticipantsBar is not available in callObject mode") : this._showParticipantsBar = !!t2.showParticipantsBar), this._callState === oi || this._callState === ii ? (console.warn("already joined meeting, call leave() before joining again"), void this.updateIsPreparingToJoin(false)) : (this._updateCallState(ii, false), this.emitDailyJSEvent({ action: Wi }), this._preloadCache.inputSettings = this._prepInputSettingsForSharing(this._inputSettings || {}, false), this.sendMessageToCallMachine({ action: "join-meeting", properties: Qa(this.properties, this.callClientId), preloadCache: Qa(this._preloadCache, this.callClientId) }, (function(t3) {
      ...
      e2._joinedCallback = function(i3, o2) {
        if (e2._callState !== ai) {
          if (o2) return e2._updateCallState(si), void n3(o2);
...
var $683f111f61e07358$export$b1ca982aa1e488c1 = class _$683f111f61e07358$export$b1ca982aa1e488c1 extends (0, $7ef5cee66c377f4d$export$86495b081fef8e52) {
  ...
  updateSpeaker(speakerId) {
    this._daily.setOutputDeviceAsync({
      ...
      this._callbacks.onDeviceError?.(new (0, $db6391dc7d757577$export$64c9f614187c1e59)([
        "speaker"
  ...
  async sendReadyMessage() {
    return new Promise((resolve) => {
      ...
      for (const id in this._daily.participants()) {
        ...
        if (!p2.local && p2.tracks?.audio?.persistentTrack) {
          sendReadyMessage();
          resolve();
          return;
        }
  ...
  handleAvailableDevicesUpdated(ev) {
    this._callbacks.onAvailableCamsUpdated?.(ev.availableDevices.filter((d2) => d2.kind === "videoinput"));
    this._callbacks.onAvailableMicsUpdated?.(ev.availableDevices.filter((d2) => d2.kind === "audioinput"));
    this._callbacks.onAvailableSpeakersUpdated?.(ev.availableDevices.filter((d2) => d2.kind === "audiooutput"));
  }
  ...
  handleParticipantJoined(ev) {
    ...
    this._callbacks.onParticipantJoined?.(p2);
    if (p2.local) return;
    this._botId = ev.participant.session_id;
    this._callbacks.onBotConnected?.(p2);
  }
  handleParticipantLeft(ev) {
    const p2 = $683f111f61e07358$var$dailyParticipantToParticipant(ev.participant);
    this._callbacks.onParticipantLeft?.(p2);
    if (p2.local) return;
    this._botId = "";
    this._callbacks.onBotDisconnected?.(p2);
  }
  ...
  handleFatalError(ev) {
    ...
    this.state = "error";
    this._botId = "";
    this._callbacks.onError?.((0, $c0d10c4690969999$export$69aa9ab0334b212).error(ev.errorMsg, true));
  }
